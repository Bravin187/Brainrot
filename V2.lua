...
introText.Text = "مرحباً بك في سكربت مجتبى\nMOJTABAㅤㅤTiktok: jn.__7"
...
local noteLabel = Instance.new("TextLabel", introFrame)
noteLabel.Size = UDim2.new(1, -40, 0, 24)
noteLabel.Position = UDim2.new(0, 20, 1, -40)
noteLabel.BackgroundTransparency = 1
noteLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
noteLabel.Font = Enum.Font.Gotham
noteLabel.TextSize = 14
noteLabel.Text = "تنويه! (السكربت ليس لمجتبى ولكن تم تعريب السكربت ونشره)"
noteLabel.TextWrapped = true
noteLabel.TextXAlignment = Enum.TextXAlignment.Center

-- بعد 3 ثواني تختفي الشاشة
task.delay(3, function()
	local fadeTime = 1.5
	TweenService:Create(introText, TweenInfo.new(fadeTime), {TextTransparency = 1}):Play()
	TweenService:Create(noteLabel, TweenInfo.new(fadeTime), {TextTransparency = 1}):Play()
	TweenService:Create(introFrame, TweenInfo.new(fadeTime), {BackgroundTransparency = 1}):Play()

	task.wait(fadeTime + 0.1)
	introGui:Destroy()

	-- بدء الواجهة بعد الترحيب
